...
namespace Tests {
    public class TestReportCreater {
        ...
        public  async void PageParse() {
            ...
            _mockIWebHelper.Setup(a => a.GetContent(It.IsAny<string>())).Returns(Task<string>);
            ...
            // Act
            Dictionary<string, string> result1 = await reportCreater.PageParse(domain);
